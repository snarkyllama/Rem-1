...
module.exports = class Duck extends Command {
    constructor(client) {
        super(client, {
            name: 'duck',
            desc: 'Gets a random duck photograph.',
            usage: '{prefix}duck',
            category: 'Animals',
            examples: [
                'duck'
        ...
        try {
            ...
            if (body.url === null) {
                ...
                return ctx.send({
                    ...
                    description: `**${ctx.author.username}**: Here is y-your duck as r-requested:`,
                    url: body.url,
                    image: {
                        url: body.url
                    },
                    footer: {
                        ...
                        text: `Powered by random-d.uk | Triggered by ${ctx.author.username}~`
                    },
                    color: ctx.client.utils.color
                });
            }
