    ...
    execute(ctx) {
        try {
            const { body } = await this.client.snek
                .get('https://augu.me/api/img/snek');
            ...
            if (body.url === null) {
                ...
                return ctx.send({
                    ...
                    description: `**${ctx.author.username}**: Here is y-your snek as r-requested:`,
                    url: body.url,
                    image: {
                        url: body.url
                    },
                    footer: {
                        ...
                        text: `Powered by augu.me | Triggered by ${ctx.author.username}~`
                    },
                    color: ctx.client.utils.color
                });
            }
